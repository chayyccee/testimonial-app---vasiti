...
import Facebook from '../images/icons/socialMedia/Facebook.svg';
import Instagram from '../images/icons/socialMedia/Instagram.svg';
import LinkedIn from '../images/icons/socialMedia/LinkedIn.svg';
            ...
            <Container>
                <Row>
                    <Col sm="12" lg="7" md="7"  className="d-flex justify-content-center box1 ">
                        <img src={footerPhone} alt="phone" className="img-fluid image-top" />
                    </Col>
