...
import womanShopping from '../images/womanShopping.png';
import underline from '../images/icons/underline.svg';


const CustomerFocus2 = () => {
                ...
                <Row>
                    <Col sm="12" lg="5" md="5" className="d-flex align-items-center text-dark pb-5 box1">
                        <div>
                            ...
                            <img src={underline} alt="pinklady" className="img-fluid" />
                      </div>
                    </Col>
                    <Col sm="12" lg="7" md="7" className="pink-img box2" >
                    <img src={womanShopping} alt="pinklady" className="img-fluid" />
                    </Col>
                </Row>
            </Container>
        </div>
